...
//                    return false;
    ...
    public void validatePasswordLastUpdate(String userName) throws UserStoreException, NamingException {
//        String searchFilter = this.realmConfig.getUserStoreProperty("UserNameSearchFilter"); //constant
//        String searchFilterReplaced = searchFilter.replace("?", this.escapeSpecialCharactersForFilter(userName));
//        String serviceNameAttribute = "pwdLastSet"; //config
//        dirContext = this.connectionSource.getContext();
//        NamingEnumeration<?> answer = null;  //GetUserProperty
